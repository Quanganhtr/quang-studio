  ...
  return (
    <div
      ...
      style={{
        ...
        aspectRatio: "1 / 1",
        backgroundColor: bg,
        borderRight: ((index + 1) % (isLg ? 3 : 2) === 0) ? "none" : (isMobile ? `0.25px solid ${borderColor}` : `${borderWidth}px dashed ${borderColor}`),
        borderBottom: isMobile ? `0.25px solid ${borderColor}` : `${borderWidth}px dashed ${borderColor}`,
